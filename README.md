...
![Forks Badge](https://img.shields.io/github/forks/Pseudo-Lab/FOMO)
![Issues Badge](https://img.shields.io/github/issues/Pseudo-Lab/FOMO)
![GitHub contributors](https://img.shields.io/github/contributors/Pseudo-Lab/FOMO?color=2b9348)
...
| :---: | :---: | :---: | :---: |
| **빌더** | [김재현](https://github.com/jh941213) | Cracked Engineer / KT DS | Vibe Coding / Agent Harness |
| **러너** | 김철완 | SK on / 데이터 분석 | AI Agent, 업무 자동화, 데이터 분석 |
| **러너** | 고남길 | 라미솔루션 COO | 에이전트 메모리 시스템, 웹 프레임워크 개발 |
| **러너** | 유상현 | WIZnet / 디지털 마케팅 매니저 | AI 콘텐츠 자동화, 수익 구조 설계 |
| **러너** | 안승원 | - | - |
| **러너** | 이규민 | KT agent팀 / 리서치 엔지니어 | AI Agent, 강화학습, 문제 정의 |
| **러너** | 이지훈 | 큐리어슬리 / 모바일 엔지니어 | AI Agent 오케스트레이션, AX 설계 |
| **러너** | 강동규 | 경희대 컴퓨터공학과 | Agent Harness 설계, PKM, 오픈소스 |
| **러너** | 유종선 | SK온 / 공정기술 엔지니어 | 제조 AI, 공정 데이터 분석 플랫폼 |
| **러너** | 이상윤 | 한글과컴퓨터 / 기술 리서치 | 바이브코딩, 에이전트 하네스 설계 |
| **러너** | 백승진 | 제이엘케이 / 백엔드 엔지니어 | Agent 아키텍처, LLMOps, Observability |
| **러너** | 김승혁 | 나무기술 AI본부 / AI 엔지니어 | AI Agent 설계, 시멘틱 네트워크, 바이브코딩 |
...
gantt
    ...
    section 모집
    러너 모집           :a1, 2025-03-01, 2025-03-12
    section 활동
    OT & 킥오프          :a2, 2025-03-15, 7d
    Weekly 아티클 리뷰    :a3, 2025-03-22, 126d
    집단지성 세션         :a4, 2025-03-22, 126d
    section 마무리
    회고 & 성과 정리      :a5, 2025-07-12, 14d
```
...
![](https://contrib.rocks/image?repo=Pseudo-Lab/FOMO)
